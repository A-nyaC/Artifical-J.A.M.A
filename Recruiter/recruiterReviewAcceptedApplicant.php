...
#$sql = "SELECT r.Applicant_ID, r.JobTitle, r.Job_ID FROM Resume r INNER JOIN AppliedJobsApplicant a
#ON r.Applicant_ID = a.Applicant_ID";

$sql = "SELECT * FROM Resume where Status = 'Accepted' and Job_ID =" . $job_id;
